...
class Anasayfa: UIViewController  {
    ...
    override func viewDidLoad() {
        ...
        let k1 = Kisiler(kisi_id: 1, kisi_ad: "Gizem", kisi_tel: "22222")
        let k2 = Kisiler(kisi_id: 2, kisi_ad: "Akif", kisi_tel: "333333")
        let k3 = Kisiler(kisi_id: 3, kisi_ad: "Beyza", kisi_tel: "44444")
...
extension Anasayfa : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        tableView.deselectRow(at: indexPath, animated: true) //son seçtiğim görünümü kaldırır.
